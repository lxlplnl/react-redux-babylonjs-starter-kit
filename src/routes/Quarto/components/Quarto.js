...
export default class Quarto extends Component {
  ...
  onWinnerFound (winners) {
    ...
    // OIMO warning undefined, seems to have no effect on game.
    // OIMO.WORLD_SCALE = 10
    // OIMO.INV_SCALE = 1 / 10
        ...
        <Panel>
          ...
          <div className='tutorial tutorialBig' id='step2'>
            <p>
                ...
                A <span className='quarto'>QUARTO</span> can be done by placing on the board four
                 pieces with a common attribute in a line or in a row.<br /><br />
          ...
          <div className='tutorial tutorialBig' id='step3'>
            <p>
                ...
                If a <span className='quarto'>QUARTO</span> is done, the current player won.
                If not, he selects a piece for his opponent, and his turn is over.<br /><br />
