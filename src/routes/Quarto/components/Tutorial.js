...
export default class Tutorial {
    ...
    constructor (scene, showAnimations) {
        this.scene = scene;
    ...
    _createAnimationStep1() {
        ...
        // TODO: no access to pieces.  this will fail.
    ...
    step1(move) {
        ...
        console.error('no access to GUI anymore. use events and reducer + state')
        GUI.colorTutorial();
